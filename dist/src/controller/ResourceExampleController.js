...
var UserController = /** @class */ (function () {
    ...
    UserController.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, email, user, userSaved, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, username = _a.username, email = _a.email;
                        user = new models_1.User({ username: username, email: email });
    ...
    UserController.updateById = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, username, email, userUpdated, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        ...
                        _a = req.body, username = _a.username, email = _a.email;
                        return [4 /*yield*/, services_1.UserService
                                .updateById(id, { username: username, email: email })];
                    case 1:
                        userUpdated = _b.sent();
                        if (!userUpdated)
                            throw new exceptions_1.HttpException(404, 'User not found');
